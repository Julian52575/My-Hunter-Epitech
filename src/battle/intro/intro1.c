...
#include "my_csfml.h"
#include "hunter.h"
static sfIntRect create_intro1(sfSprite *intro1);

void intro1(sfRenderWindow *window)
{
    sfSprite *intro1 = sfSprite_create();
    sfIntRect rect = create_intro1(intro1);
    int a = -1;
    sfMusic *m = sfMusic_createFromFile
    ("assets/battle/bgm/intro/encounter.ogg");
    sfMusic_play(m);
...
sfIntRect create_intro1(sfSprite *intro1)
{
    sfIntRect rect;
    rect.top = 5;
    rect.left = 7;
    ...
    ("assets/battle/sprites/intro/intro1.png", NULL);
